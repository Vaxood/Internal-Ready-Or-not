...
public:
	...
	uint8                                         Pad_2B4B[0x3];                                     // 0x0035(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(EyeTrackerFunctionLibrary_GetGazeData) == 0x000038, "Wrong size on EyeTrackerFunctionLibrary_GetGazeData");
...
static_assert(offsetof(EyeTrackerFunctionLibrary_GetGazeData, ReturnValue) == 0x000034, "Member 'EyeTrackerFunctionLibrary_GetGazeData::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2B4C[0x3];                                     // 0x0041(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
