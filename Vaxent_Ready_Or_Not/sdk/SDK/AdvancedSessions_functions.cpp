...
void UAdvancedIdentityLibrary::GetAllUserAccounts(TArray<struct FBPUserOnlineAccount>* AccountInfos, EBlueprintResultSwitch* Result)
{
	...
	if (AccountInfos != nullptr)
		*AccountInfos = Parms.AccountInfos;
...
void UAdvancedIdentityLibrary::GetLoginStatus(struct FBPUniqueNetId& UniqueNetId, EBPLoginStatus* LoginStatus, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
	...
	if (LoginStatus != nullptr)
		*LoginStatus = std::move(Parms.LoginStatus);
...
void UAdvancedIdentityLibrary::GetPlayerNickname(struct FBPUniqueNetId& UniqueNetId, class FString* PlayerNickname)
{
	...
	if (PlayerNickname != nullptr)
		*PlayerNickname = Parms.PlayerNickname;
}
...
void UAdvancedIdentityLibrary::GetUserAccount(struct FBPUniqueNetId& UniqueNetId, struct FBPUserOnlineAccount* AccountInfo, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedIdentityLibrary::GetUserAccountAttribute(struct FBPUserOnlineAccount& AccountInfo, const class FString& AttributeName, class FString* AttributeValue, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedIdentityLibrary::GetUserAccountAuthAttribute(struct FBPUserOnlineAccount& AccountInfo, const class FString& AttributeName, class FString* AuthAttribute, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
	...
	if (AuthAttribute != nullptr)
		*AuthAttribute = Parms.AuthAttribute;
...
void UAdvancedIdentityLibrary::SetUserAccountAttribute(struct FBPUserOnlineAccount& AccountInfo, const class FString& AttributeName, const class FString& NewAttributeValue, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedExternalUILibrary::ShowAccountUpgradeUI(struct FBPUniqueNetId& PlayerRequestingAccountUpgradeUI, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedExternalUILibrary::ShowProfileUI(struct FBPUniqueNetId& PlayerViewingProfile, struct FBPUniqueNetId& PlayerToViewProfileOf, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedExternalUILibrary::ShowWebURLUI(const class FString& URLToShow, EBlueprintResultSwitch* Result, TArray<class FString>* AllowedDomains, bool bEmbedded, bool bShowBackground, bool bShowCloseButton, int32 OffsetX, int32 OffsetY, int32 SizeX, int32 SizeY)
{
	...
	if (AllowedDomains != nullptr)
		*AllowedDomains = Parms.AllowedDomains;
}
...
void UAdvancedVoiceLibrary::GetNumLocalTalkers(int32* NumLocalTalkers)
{
	...
	if (NumLocalTalkers != nullptr)
		*NumLocalTalkers = std::move(Parms.NumLocalTalkers);
}
...
void UAdvancedVoiceLibrary::IsHeadsetPresent(bool* bHasHeadset, uint8 LocalPlayerNum)
{
	...
	if (bHasHeadset != nullptr)
		*bHasHeadset = std::move(Parms.bHasHeadset);
}
...
void UAdvancedFriendsLibrary::GetFriend(class APlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId, struct FBPFriendInfo* Friend)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedFriendsLibrary::IsAFriend(class APlayerController* PlayerController, struct FBPUniqueNetId& UniqueNetId, bool* IsFriend)
{
	static class UFunction* Func = nullptr;
	...
	if (IsFriend != nullptr)
		*IsFriend = std::move(Parms.IsFriend);
}
...
void UAdvancedFriendsLibrary::SendSessionInviteToFriend(class APlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::AddOrModifyExtraSettings(TArray<struct FSessionPropertyKeyPair>& SettingsArray, TArray<struct FSessionPropertyKeyPair>& NewOrChangedSettings, TArray<struct FSessionPropertyKeyPair>* ModifiedSettingsArray)
{
	...
	if (ModifiedSettingsArray != nullptr)
		*ModifiedSettingsArray = Parms.ModifiedSettingsArray;
}
...
void UAdvancedSessionsLibrary::FindSessionPropertyByName(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingsName, EBlueprintResultSwitch* Result, struct FSessionPropertyKeyPair* OutProperty)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::FindSessionPropertyIndexByName(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, EBlueprintResultSwitch* Result, int32* OutIndex)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetCurrentUniqueBuildID(int32* UniqueBuildId)
{
	...
	if (UniqueBuildId != nullptr)
		*UniqueBuildId = std::move(Parms.UniqueBuildId);
}
...
void UAdvancedSessionsLibrary::GetExtraSettings(const struct FBlueprintSessionResult& SessionResult, TArray<struct FSessionPropertyKeyPair>* ExtraSettings)
{
	...
	if (ExtraSettings != nullptr)
		*ExtraSettings = Parms.ExtraSettings;
}
...
void UAdvancedSessionsLibrary::GetNetPlayerIndex(class APlayerController* PlayerController, int32* NetPlayerIndex)
{
	...
	if (NetPlayerIndex != nullptr)
		*NetPlayerIndex = std::move(Parms.NetPlayerIndex);
}
...
void UAdvancedSessionsLibrary::GetNumberOfNetworkPlayers(class UObject* WorldContextObject, int32* NumNetPlayers)
{
	...
	if (NumNetPlayers != nullptr)
		*NumNetPlayers = std::move(Parms.NumNetPlayers);
}
...
void UAdvancedSessionsLibrary::GetSessionPropertyBool(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, bool* SettingValue)
{
	static class UFunction* Func = nullptr;
	...
	if (SearchResult != nullptr)
		*SearchResult = std::move(Parms.SearchResult);
...
void UAdvancedSessionsLibrary::GetSessionPropertyByte(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, uint8* SettingValue)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetSessionPropertyFloat(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, float* SettingValue)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetSessionPropertyInt(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, int32* SettingValue)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetSessionPropertyString(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, class FString* SettingValue)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetSessionSettings(class UObject* WorldContextObject, int32* NumConnections, int32* NumPrivateConnections, bool* bIsLAN, bool* bIsDedicated, bool* bAllowInvites, bool* bAllowJoinInProgress, bool* bIsAnticheatEnabled, int32* BuildUniqueID, TArray<struct FSessionPropertyKeyPair>* ExtraSettings, EBlueprintResultSwitch* Result)
{
	...
	if (NumConnections != nullptr)
		*NumConnections = std::move(Parms.NumConnections);

	if (NumPrivateConnections != nullptr)
		*NumPrivateConnections = std::move(Parms.NumPrivateConnections);

	if (bIsLAN != nullptr)
		*bIsLAN = std::move(Parms.bIsLAN);

	if (bIsDedicated != nullptr)
		*bIsDedicated = std::move(Parms.bIsDedicated);

	if (bAllowInvites != nullptr)
		*bAllowInvites = std::move(Parms.bAllowInvites);

	if (bAllowJoinInProgress != nullptr)
		*bAllowJoinInProgress = std::move(Parms.bAllowJoinInProgress);

	if (bIsAnticheatEnabled != nullptr)
		*bIsAnticheatEnabled = std::move(Parms.bIsAnticheatEnabled);

	if (BuildUniqueID != nullptr)
		*BuildUniqueID = std::move(Parms.BuildUniqueID);
...
void UAdvancedSessionsLibrary::GetSessionState(class UObject* WorldContextObject, EBPOnlineSessionState* SessionState)
{
	...
	if (SessionState != nullptr)
		*SessionState = std::move(Parms.SessionState);
}
...
void UAdvancedSessionsLibrary::IsPlayerInSession(class UObject* WorldContextObject, struct FBPUniqueNetId& PlayerToCheck, bool* bIsInSession)
{
	...
	if (bIsInSession != nullptr)
		*bIsInSession = std::move(Parms.bIsInSession);
}
...
class UDestroySessionCallbackProxyAdvanced* UDestroySessionCallbackProxyAdvanced::DestroySession(class UWorld* WorldContextObject, class APlayerController* PlayerController)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("DestroySessionCallbackProxyAdvanced", "DestroySession");

	Params::DestroySessionCallbackProxyAdvanced_DestroySession Parms{};
...
void UFindSessionsCallbackProxyAdvanced::FilterSessionResults(TArray<struct FBlueprintSessionResult>& SessionResults, TArray<struct FSessionsSearchSetting>& Filters, TArray<struct FBlueprintSessionResult>* FilteredResults)
{
	...
	if (FilteredResults != nullptr)
		*FilteredResults = Parms.FilteredResults;
}
...
class UGetUserPrivilegeCallbackProxy* UGetUserPrivilegeCallbackProxy::GetUserPrivilege(class UObject* WorldContextObject, EBPUserPrivileges& PrivilegeToCheck, struct FBPUniqueNetId& PlayerUniqueNetID)
{
	static class UFunction* Func = nullptr;
...
class UJoinSessionCallbackProxyAdvanced* UJoinSessionCallbackProxyAdvanced::JoinSession(class UWorld* WorldContextObject, class APlayerController* PlayerController, struct FBlueprintSessionResult& SearchResult)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("JoinSessionCallbackProxyAdvanced", "JoinSession");

	Params::JoinSessionCallbackProxyAdvanced_JoinSession Parms{};
