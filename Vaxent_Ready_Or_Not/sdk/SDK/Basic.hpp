...
namespace Offsets
{
	constexpr int32 GObjects          = 0x067FB120;
	constexpr int32 AppendString      = 0x0227D450;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 GWorld            = 0x0693FB10;
	constexpr int32 ProcessEvent      = 0x02470D50;
...
static_assert(alignof(FTestStruct) == 0x000002, "Wrong alignment on FTestStruct");
static_assert(sizeof(FTestStruct) == 0x000008, "Wrong size on FTestStruct");
...
{
public:
	uint8                                         Pad_3[0x28];                                       // 0x0000(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4[0x10];                                       // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5[0x4];                                        // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_7[0x28];                                       // 0x0050(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
