...
void UW_StandardCombobox_New_C::OnNewOptionSelected__DelegateSignature(int32 NewOption)
{
	...
	Params::W_StandardCombobox_New_C_OnNewOptionSelected__DelegateSignature Parms{};
...
void UW_StandardCombobox_New_C::UpdateOptionText(int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_GreaterEqual_IntInt_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, class FText CallFunc_Array_Get_Item)
{
	...
	Params::W_StandardCombobox_New_C_UpdateOptionText Parms{};
...
void UW_StandardCombobox_New_C::InsertOption(int32 Param_Index, const class FString& OptionString, class FText OptionName, class FText OptionDescription)
{
	static class UFunction* Func = nullptr;
...
void UW_StandardCombobox_New_C::DeleteOptionIndex(int32 Param_Index, bool CallFunc_GreaterEqual_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UW_StandardCombobox_New_C::GetCurrentOptionAsString(class FString* OptionAsString, const class FString& CallFunc_Array_Get_Item)
{
	...
	if (OptionAsString != nullptr)
		*OptionAsString = Parms.OptionAsString;
}
