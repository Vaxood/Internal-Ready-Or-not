...
void UW_MissionEnd_C::OpenDebriefPage(bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::W_MissionEnd_C_OpenDebriefPage Parms{};
...
void UW_MissionEnd_C::AddFooterOptions(const TMap<class FString, struct FScreenFooterEntry>& FooterEntries, const TArray<struct FScreenFooterEntry>& FooterEntriesArray, bool CallFunc_ShowCreditsButton_Show, class FString& Temp_string_Variable, class FString& Temp_string_Variable_1, class FString& Temp_string_Variable_2, class FString& Temp_string_Variable_3, bool CallFunc_ShowReturnButton_ReturnValue, bool CallFunc_ShowQuitButton_ReturnValue, bool CallFunc_ShowRestartButton_ReturnValue)
{
	...
	Params::W_MissionEnd_C_AddFooterOptions Parms{};

	Parms.FooterEntries = std::move(FooterEntries);
	Parms.FooterEntriesArray = std::move(FooterEntriesArray);
...
bool UW_MissionEnd_C::ShowRestartButton(class AGameModeBase* CallFunc_GetGameMode_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue, class ACommanderGM* K2Node_DynamicCast_AsCommander_GM, bool K2Node_DynamicCast_bSuccess, bool CallFunc_HasAuthority_ReturnValue) const
{
	static class UFunction* Func = nullptr;
...
bool UW_MissionEnd_C::ShowReturnButton(bool CallFunc_IsCommanderMode_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue, bool CallFunc_HasAuthority_ReturnValue) const
{
	static class UFunction* Func = nullptr;
...
class UWidget* UW_MissionEnd_C::BP_GetDesiredFocusTarget(class UWidget* CallFunc_GetFocusTarget_Focus) const
{
	static class UFunction* Func = nullptr;
...
ESlateVisibility UW_MissionEnd_C::GetDebriefButtonVisibility(bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsCommanderMode_ReturnValue, bool CallFunc_BooleanAND_ReturnValue) const
{
	static class UFunction* Func = nullptr;
