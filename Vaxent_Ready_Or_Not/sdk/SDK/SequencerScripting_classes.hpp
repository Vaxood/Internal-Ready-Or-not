...
{
public:
	static class UMovieSceneTrack* AddTrack(struct FSequencerBindingProxy& InBinding, TSubclassOf<class UMovieSceneTrack> TrackType);
	static TArray<class UMovieSceneTrack*> FindTracksByExactType(struct FSequencerBindingProxy& InBinding, TSubclassOf<class UMovieSceneTrack> TrackType);
	static TArray<class UMovieSceneTrack*> FindTracksByType(struct FSequencerBindingProxy& InBinding, TSubclassOf<class UMovieSceneTrack> TrackType);
	static TArray<struct FSequencerBindingProxy> GetChildPossessables(struct FSequencerBindingProxy& InBinding);
	static class FText GetDisplayName(struct FSequencerBindingProxy& InBinding);
	static struct FGuid GetId(struct FSequencerBindingProxy& InBinding);
	static class FString GetName(struct FSequencerBindingProxy& InBinding);
	static class UObject* GetObjectTemplate(struct FSequencerBindingProxy& InBinding);
	static struct FSequencerBindingProxy GetParent(struct FSequencerBindingProxy& InBinding);
	static class UClass* GetPossessedObjectClass(struct FSequencerBindingProxy& InBinding);
	static TArray<class UMovieSceneTrack*> GetTracks(struct FSequencerBindingProxy& InBinding);
	static bool IsValid(struct FSequencerBindingProxy& InBinding);
	static void MoveBindingContents(struct FSequencerBindingProxy& SourceBindingId, struct FSequencerBindingProxy& DestinationBindingId);
	static void Remove(struct FSequencerBindingProxy& InBinding);
	static void RemoveTrack(struct FSequencerBindingProxy& InBinding, class UMovieSceneTrack* TrackToRemove);
	static void SetDisplayName(struct FSequencerBindingProxy& InBinding, class FText& InDisplayName);
	static void SetName(struct FSequencerBindingProxy& InBinding, const class FString& InName);
	static void SetParent(struct FSequencerBindingProxy& InBinding, struct FSequencerBindingProxy& InParentBinding);
...
public:
	...
	static bool RemoveChildObjectBinding(class UMovieSceneFolder* Folder, struct FSequencerBindingProxy& InObjectBinding);
...
{
public:
	uint8                                         Pad_16C6[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16C7[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16CA[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16CC[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16CF[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16D3[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16D6[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16D9[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16DC[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16DF[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16E2[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16E5[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16E8[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16EA[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16ED[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16F0[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16F3[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static struct FMovieSceneObjectBindingID GetBindingID(struct FSequencerBindingProxy& InBinding);
	...
	static struct FMovieSceneObjectBindingID GetPortableBindingID(class UMovieSceneSequence* MasterSequence, class UMovieSceneSequence* DestinationSequence, struct FSequencerBindingProxy& InBinding);
	...
	static TArray<class UObject*> LocateBoundObjects(class UMovieSceneSequence* Sequence, struct FSequencerBindingProxy& InBinding, class UObject* Context);
	static struct FMovieSceneObjectBindingID MakeBindingID(class UMovieSceneSequence* MasterSequence, struct FSequencerBindingProxy& InBinding, EMovieSceneObjectBindingSpace Space);
