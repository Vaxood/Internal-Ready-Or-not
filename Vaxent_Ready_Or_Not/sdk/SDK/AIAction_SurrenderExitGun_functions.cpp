...
bool UAIAction_SurrenderExitGun_C::ShouldPerformAction(bool CallFunc_Not_PreBool_ReturnValue) const
{
	static class UFunction* Func = nullptr;
...
void UAIAction_SurrenderExitGun_C::IsFakeExit(ESurrenderExitType ExitType, bool* Return_Value, bool K2Node_SwitchEnum_CmpSuccess) const
{
	static class UFunction* Func = nullptr;
