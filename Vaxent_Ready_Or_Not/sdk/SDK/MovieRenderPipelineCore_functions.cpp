...
void UMoviePipelineBlueprintLibrary::GetOverallOutputFrames(class UMoviePipeline* InMoviePipeline, int32* OutCurrentIndex, int32* OutTotalCount)
{
	...
	if (OutCurrentIndex != nullptr)
		*OutCurrentIndex = std::move(Parms.OutCurrentIndex);

	if (OutTotalCount != nullptr)
		*OutTotalCount = std::move(Parms.OutTotalCount);
}
...
void UMoviePipelineBlueprintLibrary::ResolveFilenameFormatArguments(const class FString& InFormatString, struct FMoviePipelineFilenameResolveParams& InParams, class FString* OutFinalPath, struct FMoviePipelineFormatArgs* OutMergedFormatArgs)
{
	...
	if (OutFinalPath != nullptr)
		*OutFinalPath = Parms.OutFinalPath;

	if (OutMergedFormatArgs != nullptr)
		*OutMergedFormatArgs = Parms.OutMergedFormatArgs;
}
...
void UMoviePipelineBlueprintLibrary::UpdateJobShotListFromSequence(class ULevelSequence* InSequence, class UMoviePipelineExecutorJob* InJob, bool* bShotsChanged)
{
	...
	if (bShotsChanged != nullptr)
		*bShotsChanged = std::move(Parms.bShotsChanged);
}
...
class UMoviePipelineSetting* UMoviePipelineConfigBase::FindSettingByClass(TSubclassOf<class UMoviePipelineSetting> InClass, bool bIncludeDisabledSettings) const
{
	static class UFunction* Func = nullptr;
...
TArray<class UMoviePipelineSetting*> UMoviePipelineConfigBase::FindSettingsByClass(TSubclassOf<class UMoviePipelineSetting> InClass, bool bIncludeDisabledSettings) const
{
	static class UFunction* Func = nullptr;
...
TArray<class UMoviePipelineSetting*> UMoviePipelineMasterConfig::GetAllSettings(bool bIncludeDisabledSettings, bool bIncludeTransientSettings) const
{
	static class UFunction* Func = nullptr;
...
struct FFrameRate UMoviePipelineMasterConfig::GetEffectiveFrameRate(class ULevelSequence* InSequence) const
{
	static class UFunction* Func = nullptr;
