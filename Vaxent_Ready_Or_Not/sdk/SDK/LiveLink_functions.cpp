...
TSubclassOf<class ULiveLinkRole> ULiveLinkBlueprintLibrary::GetLiveLinkSubjectRole(struct FLiveLinkSubjectName& SubjectName)
{
	static class UFunction* Func = nullptr;
...
TSubclassOf<class ULiveLinkRole> ULiveLinkBlueprintLibrary::GetSpecificLiveLinkSubjectRole(struct FLiveLinkSubjectKey& SubjectKey)
{
	static class UFunction* Func = nullptr;
...
void ULiveLinkBlueprintLibrary::TransformNames(struct FSubjectFrameHandle& SubjectFrameHandle, TArray<class FName>* Param_TransformNames)
{
	...
	if (Param_TransformNames != nullptr)
		*Param_TransformNames = Parms.Param_TransformNames;
}
