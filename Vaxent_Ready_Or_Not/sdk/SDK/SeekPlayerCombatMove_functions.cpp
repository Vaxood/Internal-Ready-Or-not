...
class FName USeekPlayerCombatMove_C::GetMoveStyleOverride(class ACyberneticCharacter* CallFunc_GetCharacter_ReturnValue, bool CallFunc_IsCivilian_ReturnValue) const
{
	static class UFunction* Func = nullptr;
