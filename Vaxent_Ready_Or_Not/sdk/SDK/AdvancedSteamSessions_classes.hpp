...
{
public:
	static struct FBPUniqueNetId CreateSteamIDFromString(class FString& SteamID64);
	static bool FilterText(const class FString& TextToFilter, EBPTextFilteringContext Context, struct FBPUniqueNetId& TextSourceID, class FString* FilteredText);
	static int32 GetFriendSteamLevel(struct FBPUniqueNetId& UniqueNetId);
	static struct FBPUniqueNetId GetLocalSteamIDFromSteam();
	static class UTexture2D* GetSteamFriendAvatar(struct FBPUniqueNetId& UniqueNetId, EBlueprintAsyncResultSwitch* Result, ESteamAvatarSize AvatarSize);
	static void GetSteamFriendGamePlayed(struct FBPUniqueNetId& UniqueNetId, EBlueprintResultSwitch* Result, int32* AppId);
	static void GetSteamGroups(TArray<struct FBPSteamGroupInfo>* SteamGroups);
	static class FString GetSteamPersonaName(struct FBPUniqueNetId& UniqueNetId);
	static bool InitTextFiltering();
	static bool IsOverlayEnabled();
	static bool IsSteamInBigPictureMode();
	static bool OpenSteamUserOverlay(struct FBPUniqueNetId& UniqueNetId, ESteamUserOverlayType DialogType);
	static bool RequestSteamFriendInfo(struct FBPUniqueNetId& UniqueNetId, bool bRequireNameOnly);
...
public:
	...
	uint8                                         Pad_DAA[0x50];                                     // 0x0050(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_DAB[0x38];                                     // 0x0050(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
