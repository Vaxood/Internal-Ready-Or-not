...
class UMagicLeapARPinSaveGame* UMagicLeapARPinComponent::TryGetPinData(TSubclassOf<class UMagicLeapARPinSaveGame> InPinDataClass, bool* OutPinDataValid)
{
	...
	if (OutPinDataValid != nullptr)
		*OutPinDataValid = std::move(Parms.OutPinDataValid);
...
void UMagicLeapARPinFunctionLibrary::BindToOnMagicLeapARPinUpdatedDelegate(TDelegate<void(TArray<struct FGuid>& Added, TArray<struct FGuid>& Updated, TArray<struct FGuid>& Deleted)>& Delegate)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TDelegate<void(struct FGuid& PinId, TSet<class FString>& PinnedObjectIds)>Delegate                                               (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UMagicLeapARPinFunctionLibrary::BindToOnMagicLeapContentBindingFoundDelegate(TDelegate<void(struct FGuid& PinId, TSet<class FString>& PinnedObjectIds)>& Delegate)
{
	static class UFunction* Func = nullptr;
...
EMagicLeapPassableWorldError UMagicLeapARPinFunctionLibrary::GetARPinState(struct FGuid& PinId, struct FMagicLeapARPinState* State)
{
	static class UFunction* Func = nullptr;
...
EMagicLeapPassableWorldError UMagicLeapARPinFunctionLibrary::GetClosestARPin(struct FVector& SearchPoint, struct FGuid* PinId)
{
	static class UFunction* Func = nullptr;
...
EMagicLeapPassableWorldError UMagicLeapARPinFunctionLibrary::GetGlobalQueryFilter(struct FMagicLeapARPinQuery* CurrentGlobalFilter)
{
	...
	if (CurrentGlobalFilter != nullptr)
		*CurrentGlobalFilter = Parms.CurrentGlobalFilter;
...
EMagicLeapPassableWorldError UMagicLeapARPinFunctionLibrary::QueryARPins(struct FMagicLeapARPinQuery& Query, TArray<struct FGuid>* Pins)
{
	static class UFunction* Func = nullptr;
...
EMagicLeapPassableWorldError UMagicLeapARPinFunctionLibrary::SetGlobalQueryFilter(struct FMagicLeapARPinQuery& InGlobalFilter)
{
	static class UFunction* Func = nullptr;
...
void UMagicLeapARPinFunctionLibrary::UnBindToOnMagicLeapARPinUpdatedDelegate(TDelegate<void(TArray<struct FGuid>& Added, TArray<struct FGuid>& Updated, TArray<struct FGuid>& Deleted)>& Delegate)
{
	static class UFunction* Func = nullptr;
...
void UMagicLeapARPinFunctionLibrary::UnBindToOnMagicLeapContentBindingFoundDelegate(TDelegate<void(struct FGuid& PinId, TSet<class FString>& PinnedObjectIds)>& Delegate)
{
	static class UFunction* Func = nullptr;
