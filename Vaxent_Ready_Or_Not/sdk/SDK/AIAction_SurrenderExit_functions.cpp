...
// ESurrenderExitType                      CallFunc_DetermineSurrenderExitType_ReturnValue        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
bool UAIAction_SurrenderExit_C::ShouldPerformAction(bool CallFunc_Not_PreBool_ReturnValue) const
{
	static class UFunction* Func = nullptr;
...
void UAIAction_SurrenderExit_C::IsFakeExit(ESurrenderExitType ExitType, bool* Return_Value, bool K2Node_SwitchEnum_CmpSuccess) const
{
	static class UFunction* Func = nullptr;
