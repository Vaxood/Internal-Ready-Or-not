...
public:
	...
	uint8                                         Pad_1C40[0x5];                                     // 0x002B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1C41[0x8];                                     // 0x0120(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1C45[0x68];                                    // 0x00B0(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void RaycastResultDelegate__DelegateSignature(const struct FMagicLeapRaycastHitResult& HitResult);
	bool RequestRaycast(struct FMagicLeapRaycastQueryParams& RequestParams, TDelegate<void(const struct FMagicLeapRaycastHitResult& HitResult)>& ResultDelegate);
...
{
public:
	FMulticastInlineDelegateProperty_             OnHeadTrackingLost;                                // 0x0160(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnHeadTrackingRecovered;                           // 0x0170(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnHeadTrackingRecoveryFailed;                      // 0x0180(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnHeadTrackingNewSessionStarted;                   // 0x0190(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C47[0x50];                                    // 0x01A0(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMagicLeapHeadTrackingNotificationsComponent) == 0x0001F0, "Wrong size on UMagicLeapHeadTrackingNotificationsComponent");
static_assert(offsetof(UMagicLeapHeadTrackingNotificationsComponent, OnHeadTrackingLost) == 0x000160, "Member 'UMagicLeapHeadTrackingNotificationsComponent::OnHeadTrackingLost' has a wrong offset!");
static_assert(offsetof(UMagicLeapHeadTrackingNotificationsComponent, OnHeadTrackingRecovered) == 0x000170, "Member 'UMagicLeapHeadTrackingNotificationsComponent::OnHeadTrackingRecovered' has a wrong offset!");
static_assert(offsetof(UMagicLeapHeadTrackingNotificationsComponent, OnHeadTrackingRecoveryFailed) == 0x000180, "Member 'UMagicLeapHeadTrackingNotificationsComponent::OnHeadTrackingRecoveryFailed' has a wrong offset!");
static_assert(offsetof(UMagicLeapHeadTrackingNotificationsComponent, OnHeadTrackingNewSessionStarted) == 0x000190, "Member 'UMagicLeapHeadTrackingNotificationsComponent::OnHeadTrackingNewSessionStarted' has a wrong offset!");
...
public:
	...
	static void SetBaseOrientation(struct FQuat& InBaseOrientation);
	static void SetBasePosition(struct FVector& InBasePosition);
	static void SetBaseRotation(struct FRotator& InBaseRotation);
...
{
public:
	uint8                                         Pad_1C4D[0x8];                                     // 0x01F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C4E[0x6];                                     // 0x0212(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C4F[0x3];                                     // 0x0221(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C50[0x3];                                     // 0x0229(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C51[0x5];                                     // 0x0233(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C52[0x7];                                     // 0x0269(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C53[0x14];                                    // 0x027C(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
