...
void UW_PreMission_Tablet_Brief_Audio_C::ExecuteUbergraph_W_PreMission_Tablet_Brief_Audio(int32 EntryPoint, const struct FGeometry& K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, bool K2Node_Event_IsDesignTime, struct FMissionAudio& K2Node_CustomEvent_Audio, float K2Node_ComponentBoundEvent_EventAudioStart, float K2Node_ComponentBoundEvent_EventAudioDuration, float K2Node_ComponentBoundEvent_EventID, class ATablet* CallFunc_GetPlayerTablet_ReturnValue, class UFMODAudioComponent* CallFunc_PlayEventAttached_ReturnValue, bool CallFunc_IsValid_ReturnValue, float K2Node_ComponentBoundEvent_ClipStartTime)
{
	...
	Parms.K2Node_CustomEvent_Audio = std::move(K2Node_CustomEvent_Audio);
...
void UW_PreMission_Tablet_Brief_Audio_C::Initialize(struct FMissionAudio& Audio)
{
	static class UFunction* Func = nullptr;
...
void UW_PreMission_Tablet_Brief_Audio_C::GetEventEntries(bool ForceUpdate, TMap<float, struct FTimelineEvent>* EventEntries1, bool Initialized, const TMap<float, struct FTimelineEvent>& EventEntries, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, const struct FTimelineEvent& CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Parms.EventEntries = std::move(EventEntries);
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_Rewinding                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    CallFunc_IsValid_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor)
// int32                                   CallFunc_GetScrubbedTime_ReturnValue                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_PreMission_Tablet_Brief_Audio_C::ScrubTime(bool Param_Rewinding, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_GetScrubbedTime_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Rewinding = Param_Rewinding;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
...
void UW_PreMission_Tablet_Brief_Audio_C::IsPlayingAudio(bool* Playing, bool CallFunc_IsPlaying_ReturnValue)
{
	...
	if (Playing != nullptr)
		*Playing = std::move(Parms.Playing);
}
