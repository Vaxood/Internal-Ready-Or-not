...
// TDelegate<void(TSubclassOf<class UObject> Loaded)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
...
// Parameters:
// class FString                           Param_MissionURL                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// struct FLevelDataLookupTable            Param_LevelData                                        (BlueprintVisible, BlueprintReadOnly, Parm)

void UW_PreMission_Tablet_Objectives_C::MissionChanged(const class FString& Param_MissionURL, const struct FLevelDataLookupTable& Param_LevelData)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_MissionURL = std::move(Param_MissionURL);
	Parms.Param_LevelData = std::move(Param_LevelData);
