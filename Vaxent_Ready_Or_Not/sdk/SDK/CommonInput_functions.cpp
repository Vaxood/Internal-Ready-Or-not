...
const TArray<class FName> UCommonInputSettings::GetRegisteredPlatforms()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("CommonInputSettings", "GetRegisteredPlatforms");

	Params::CommonInputSettings_GetRegisteredPlatforms Parms{};
