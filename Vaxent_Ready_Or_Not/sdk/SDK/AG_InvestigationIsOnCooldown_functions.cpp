...
#include "AG_InvestigationIsOnCooldown_classes.hpp"
#include "AG_InvestigationIsOnCooldown_parameters.hpp"
...
bool UAG_InvestigationIsOnCooldown_C::CanOpen(struct FAIActionDecisionContext& Context, TSubclassOf<class UBaseActivity> Temp_class_Variable, class UActivityManager* CallFunc_GetWorldSubsystem_ReturnValue, float CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AG_InvestigationIsOnCooldown_C", "CanOpen");

	Params::AG_InvestigationIsOnCooldown_C_CanOpen Parms{};
