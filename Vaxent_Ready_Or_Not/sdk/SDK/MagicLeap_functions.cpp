...
bool UMagicLeapRaycastComponent::RequestRaycast(struct FMagicLeapRaycastQueryParams& RequestParams, TDelegate<void(const struct FMagicLeapRaycastHitResult& HitResult)>& ResultDelegate)
{
	static class UFunction* Func = nullptr;
...
bool UMagicLeapHMDFunctionLibrary::GetGraphicsClientPerformanceInfo(struct FMagicLeapGraphicsClientPerformanceInfo* PerformanceInfo)
{
	...
	if (PerformanceInfo != nullptr)
		*PerformanceInfo = Parms.PerformanceInfo;
