...
static_assert(alignof(CommonInputSettings_GetRegisteredPlatforms) == 0x000008, "Wrong alignment on CommonInputSettings_GetRegisteredPlatforms");
static_assert(sizeof(CommonInputSettings_GetRegisteredPlatforms) == 0x000010, "Wrong size on CommonInputSettings_GetRegisteredPlatforms");
static_assert(offsetof(CommonInputSettings_GetRegisteredPlatforms, ReturnValue) == 0x000000, "Member 'CommonInputSettings_GetRegisteredPlatforms::ReturnValue' has a wrong offset!");
