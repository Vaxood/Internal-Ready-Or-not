...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int32                                   InCharacterLimit                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                           InTruncationCharacters                                 (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UTextBlock::TruncateText(int32 InCharacterLimit, const class FString& InTruncationCharacters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TextBlock", "TruncateText");

	Params::TextBlock_TruncateText Parms{};

	Parms.InCharacterLimit = InCharacterLimit;
	Parms.InTruncationCharacters = std::move(InTruncationCharacters);
