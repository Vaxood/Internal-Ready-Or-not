...
static_assert(alignof(SoundUtilitiesBPFunctionLibrary_GetLinearFrequencyClamped) == 0x000004, "Wrong alignment on SoundUtilitiesBPFunctionLibrary_GetLinearFrequencyClamped");
...
static_assert(offsetof(SoundUtilitiesBPFunctionLibrary_GetLinearFrequencyClamped, InDomain) == 0x000004, "Member 'SoundUtilitiesBPFunctionLibrary_GetLinearFrequencyClamped::InDomain' has a wrong offset!");
static_assert(offsetof(SoundUtilitiesBPFunctionLibrary_GetLinearFrequencyClamped, InRange) == 0x00000C, "Member 'SoundUtilitiesBPFunctionLibrary_GetLinearFrequencyClamped::InRange' has a wrong offset!");
static_assert(offsetof(SoundUtilitiesBPFunctionLibrary_GetLinearFrequencyClamped, ReturnValue) == 0x000014, "Member 'SoundUtilitiesBPFunctionLibrary_GetLinearFrequencyClamped::ReturnValue' has a wrong offset!");
...
static_assert(alignof(SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped) == 0x000004, "Wrong alignment on SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped");
static_assert(sizeof(SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped) == 0x000018, "Wrong size on SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped");
...
static_assert(offsetof(SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped, InDomain) == 0x000004, "Member 'SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped::InDomain' has a wrong offset!");
static_assert(offsetof(SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped, InRange) == 0x00000C, "Member 'SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped::InRange' has a wrong offset!");
static_assert(offsetof(SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped, ReturnValue) == 0x000014, "Member 'SoundUtilitiesBPFunctionLibrary_GetLogFrequencyClamped::ReturnValue' has a wrong offset!");
