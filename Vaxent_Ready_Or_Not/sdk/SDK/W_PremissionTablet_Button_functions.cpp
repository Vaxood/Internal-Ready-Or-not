...
void UW_PremissionTablet_Button_C::OnClicked__DelegateSignature(class UW_PremissionTablet_Button_C* TriggeringButton)
{
	...
	Params::W_PremissionTablet_Button_C_OnClicked__DelegateSignature Parms{};
...
void UW_PremissionTablet_Button_C::OnActiveStateChange__DelegateSignature(bool Active)
{
	...
	Params::W_PremissionTablet_Button_C_OnActiveStateChange__DelegateSignature Parms{};
...
void UW_PremissionTablet_Button_C::GetIsActive(bool* Param_IsActive)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_IsActive != nullptr)
		*Param_IsActive = std::move(Parms.Param_IsActive);
}
