...
bool UMagicLeapAudioFunctionLibrary::SetOnAudioJackPluggedDelegate(TDelegate<void()>& ResultDelegate)
{
	static class UFunction* Func = nullptr;
...
bool UMagicLeapAudioFunctionLibrary::SetOnAudioJackUnpluggedDelegate(TDelegate<void()>& ResultDelegate)
{
	static class UFunction* Func = nullptr;
