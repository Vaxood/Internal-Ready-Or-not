...
bool UAssetTagsSubsystem::CollectionExists(class FName Param_Name)
{
...
TArray<struct FAssetData> UAssetTagsSubsystem::GetAssetsInCollection(class FName Param_Name)
{
	static class UFunction* Func = nullptr;
