...
static_assert(sizeof(AFMODAmbientSound) == 0x000228, "Wrong size on AFMODAmbientSound");
static_assert(offsetof(AFMODAmbientSound, AudioComponent) == 0x000220, "Member 'AFMODAmbientSound::AudioComponent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_E74[0x7];                                      // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E75[0x7];                                      // 0x0261(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E76[0xD9];                                     // 0x02B7(0x00D9)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFMODAudioComponent) == 0x000390, "Wrong size on UFMODAudioComponent");
static_assert(offsetof(UFMODAudioComponent, Event) == 0x0001F8, "Member 'UFMODAudioComponent::Event' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, ParameterCache) == 0x000200, "Member 'UFMODAudioComponent::ParameterCache' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, ProgrammerSoundName) == 0x000250, "Member 'UFMODAudioComponent::ProgrammerSoundName' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnEventStopped) == 0x000268, "Member 'UFMODAudioComponent::OnEventStopped' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnSoundStopped) == 0x000278, "Member 'UFMODAudioComponent::OnSoundStopped' has a wrong offset!");
...
public:
	...
	static void EventInstanceSetTransform(const struct FFMODEventInstance& EventInstance, struct FTransform& Location);
	...
	static struct FFMODEventInstance PlayEventAtLocation(class UObject* WorldContextObject, class UFMODEvent* Event, struct FTransform& Location, bool bAutoPlay);
...
{
public:
	uint8                                         Pad_E8B[0x8];                                      // 0x0090(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_E8C[0x8];                                      // 0x0090(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E8D[0x4];                                      // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E8E[0x6];                                      // 0x0042(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E8F[0x3];                                      // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E90[0x4];                                      // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E91[0x3];                                      // 0x0091(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E92[0x2];                                      // 0x00B6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E93[0x7];                                      // 0x0129(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E94[0x10];                                     // 0x01B0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFMODSettings) == 0x0001C0, "Wrong size on UFMODSettings");
...
static_assert(offsetof(UFMODSettings, Vol0VirtualLevel) == 0x000058, "Member 'UFMODSettings::Vol0VirtualLevel' has a wrong offset!");
static_assert(offsetof(UFMODSettings, SampleRate) == 0x00005C, "Member 'UFMODSettings::SampleRate' has a wrong offset!");
static_assert(offsetof(UFMODSettings, bMatchHardwareSampleRate) == 0x000060, "Member 'UFMODSettings::bMatchHardwareSampleRate' has a wrong offset!");
static_assert(offsetof(UFMODSettings, RealChannelCount) == 0x000064, "Member 'UFMODSettings::RealChannelCount' has a wrong offset!");
static_assert(offsetof(UFMODSettings, TotalChannelCount) == 0x000068, "Member 'UFMODSettings::TotalChannelCount' has a wrong offset!");
static_assert(offsetof(UFMODSettings, DSPBufferLength) == 0x00006C, "Member 'UFMODSettings::DSPBufferLength' has a wrong offset!");
static_assert(offsetof(UFMODSettings, DSPBufferCount) == 0x000070, "Member 'UFMODSettings::DSPBufferCount' has a wrong offset!");
static_assert(offsetof(UFMODSettings, FileBufferSize) == 0x000074, "Member 'UFMODSettings::FileBufferSize' has a wrong offset!");
static_assert(offsetof(UFMODSettings, StudioUpdatePeriod) == 0x000078, "Member 'UFMODSettings::StudioUpdatePeriod' has a wrong offset!");
...
static_assert(offsetof(UFMODSettings, Platforms) == 0x000160, "Member 'UFMODSettings::Platforms' has a wrong offset!");
...
class UFMODWorldSubsystem final  : public UWorldSubsystem
{
public:
	TArray<class UFMODAudioComponent*>            AnimNotifyAudioPool;                               // 0x0030(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UFMODAudioComponent*>            AnimNotifyAudioPool_InUse;                         // 0x0040(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UFMODAudioComponent*>            WorldAudioPool;                                    // 0x0050(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UFMODAudioComponent*>            WorldAudioPool_InUse;                              // 0x0060(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"FMODWorldSubsystem">();
	}
	static class UFMODWorldSubsystem* GetDefaultObj()
	{
		return GetDefaultObjImpl<UFMODWorldSubsystem>();
	}
};
static_assert(alignof(UFMODWorldSubsystem) == 0x000008, "Wrong alignment on UFMODWorldSubsystem");
static_assert(sizeof(UFMODWorldSubsystem) == 0x000070, "Wrong size on UFMODWorldSubsystem");
static_assert(offsetof(UFMODWorldSubsystem, AnimNotifyAudioPool) == 0x000030, "Member 'UFMODWorldSubsystem::AnimNotifyAudioPool' has a wrong offset!");
static_assert(offsetof(UFMODWorldSubsystem, AnimNotifyAudioPool_InUse) == 0x000040, "Member 'UFMODWorldSubsystem::AnimNotifyAudioPool_InUse' has a wrong offset!");
static_assert(offsetof(UFMODWorldSubsystem, WorldAudioPool) == 0x000050, "Member 'UFMODWorldSubsystem::WorldAudioPool' has a wrong offset!");
static_assert(offsetof(UFMODWorldSubsystem, WorldAudioPool_InUse) == 0x000060, "Member 'UFMODWorldSubsystem::WorldAudioPool_InUse' has a wrong offset!");
