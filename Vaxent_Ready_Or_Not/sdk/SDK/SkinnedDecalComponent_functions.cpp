...
void USkinnedDecalSampler::RemoveDecal(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
int32 USkinnedDecalSampler::SpawnDecal(const struct FVector& Location, struct FQuat& Rotation, class FName BoneName, float Size, int32 SubUV, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
