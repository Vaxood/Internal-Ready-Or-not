...
public:
	...
	uint8                                         Pad_1D2A[0x3];                                     // 0x021D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D2B[0x4];                                     // 0x0224(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D2C[0x18];                                    // 0x0248(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static struct FTransform GetContentScale(class AActor* ContentActor, struct FMagicLeapPlaneResult& PlaneResult);
	static bool IsTrackerValid();
	static bool PlanesPersistentQueryBeginAsync(struct FMagicLeapPlanesQuery& Query, struct FGuid& Handle, TDelegate<void(bool bSuccess, struct FGuid& QueryHandle, EMagicLeapPlaneQueryType QueryType, TArray<struct FMagicLeapPlaneResult>& NewPlanes, TArray<struct FGuid>& RemovedPlaneIDs, TArray<struct FMagicLeapPlaneBoundaries>& NewPolygons, TArray<struct FGuid>& RemovedPolygonIDs)>& ResultDelegate);
	static bool PlanesQueryBeginAsync(struct FMagicLeapPlanesQuery& Query, TDelegate<void(bool bSuccess, TArray<struct FMagicLeapPlaneResult>& Planes, TArray<struct FMagicLeapPlaneBoundaries>& Polygons)>& ResultDelegate);
