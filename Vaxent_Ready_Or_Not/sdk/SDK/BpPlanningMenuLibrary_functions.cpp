...
// class FText                             CallFunc_CreateOverviewPersonnelListText_Text          ()
...
void UBpPlanningMenuLibrary_C::GetActivePersonnelText(class UObject* __WorldContext, class FText* Text, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class ACoopGS* K2Node_DynamicCast_AsCoop_GS, bool K2Node_DynamicCast_bSuccess, TArray<int32>& CallFunc_GetEnabledPersonnel_ReturnValue, class FText CallFunc_CreateOverviewPersonnelListText_Text)
{
	...
	Parms.CallFunc_GetEnabledPersonnel_ReturnValue = std::move(CallFunc_GetEnabledPersonnel_ReturnValue);
	Parms.CallFunc_CreateOverviewPersonnelListText_Text = CallFunc_CreateOverviewPersonnelListText_Text;

	GetDefaultObj()->ProcessEvent(Func, &Parms);

	CallFunc_GetEnabledPersonnel_ReturnValue = std::move(Parms.CallFunc_GetEnabledPersonnel_ReturnValue);
...
// class FText                             CallFunc_CreateOverviewDeployableListText_Text         ()
...
void UBpPlanningMenuLibrary_C::GetActiveDeployablesText(class UObject* __WorldContext, class FText* Text, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class ACoopGS* K2Node_DynamicCast_AsCoop_GS, bool K2Node_DynamicCast_bSuccess, TArray<int32>& CallFunc_GetEnabledDeployables_ReturnValue, class FText CallFunc_CreateOverviewDeployableListText_Text)
{
	...
	Parms.K2Node_DynamicCast_AsCoop_GS = K2Node_DynamicCast_AsCoop_GS;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
	Parms.CallFunc_GetEnabledDeployables_ReturnValue = std::move(CallFunc_GetEnabledDeployables_ReturnValue);
	Parms.CallFunc_CreateOverviewDeployableListText_Text = CallFunc_CreateOverviewDeployableListText_Text;

	GetDefaultObj()->ProcessEvent(Func, &Parms);

	CallFunc_GetEnabledDeployables_ReturnValue = std::move(Parms.CallFunc_GetEnabledDeployables_ReturnValue);
...
// EWeaponType                             CallFunc_Array_Get_Item                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   CallFunc_Array_Length_ReturnValue                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    CallFunc_Less_IntInt_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor)

void UBpPlanningMenuLibrary_C::GetFirstWeaponType(TArray<EWeaponType>& WeaponTypes, class UObject* __WorldContext, EWeaponType* WeaponType, EWeaponType CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	if (WeaponType != nullptr)
		*WeaponType = std::move(Parms.WeaponType);
}
...
// EWeaponType                             Temp_byte_Variable                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBpPlanningMenuLibrary_C::GetWeaponTypeLocalizedName(EWeaponType WeaponType, class UObject* __WorldContext, class FText* LocalizedName, class FText UnarmedWeaponType, class FText SpecialWeaponType, class FText LessLethalPrimaryWeaponType, class FText LessLethalPistolWeaponType, class FText LethalPistolWeaponType, class FText ShotgunWeaponType, class FText SubmachineWeaponType, class FText RifleWeaponType, class FText NoWeaponType, EWeaponType Temp_byte_Variable, class FText Temp_text_Variable, class FText Temp_text_Variable_1, class FText Temp_text_Variable_2, class FText Temp_text_Variable_3, class FText Temp_text_Variable_4, class FText Temp_text_Variable_5, class FText Temp_text_Variable_6, class FText Temp_text_Variable_7, class FText Temp_text_Variable_8, class FText Temp_text_Variable_9, class FText K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UBpPlanningMenuLibrary_C::GetAttachmentTextData(class UClass* Attachment, class UObject* __WorldContext, ESlateVisibility* Visibility, class FText* Text, bool CallFunc_IsValidClass_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	if (Visibility != nullptr)
		*Visibility = std::move(Parms.Visibility);
...
// class ABaseMagazineWeapon*              CallFunc_GetClassDefaultObject_ReturnValue             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    CallFunc_BooleanOR_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    CallFunc_BooleanOR_ReturnValue_1                       (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    CallFunc_BooleanOR_ReturnValue_2                       (ZeroConstructor, IsPlainOldData, NoDestructor)

void UBpPlanningMenuLibrary_C::CanCustomizeWeaponClass(class UClass* WeaponClass, class UObject* __WorldContext, bool* CanCustomize, class ABaseMagazineWeapon* CallFunc_GetClassDefaultObject_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue_2)
{
	static class UFunction* Func = nullptr;
	...
	if (CanCustomize != nullptr)
		*CanCustomize = std::move(Parms.CanCustomize);
}
...
void UBpPlanningMenuLibrary_C::GetNonDefaultLoadouts(class UObject* __WorldContext, TArray<class FString>* Loadouts, const TArray<class FString>& LoadoutNames, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class FString>& CallFunc_GetLoadoutNames_LoadoutNames, bool CallFunc_GetLoadoutNames_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, const class FString& CallFunc_Array_Get_Item, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_NotEqual_StriStri_ReturnValue, bool CallFunc_NotEqual_StriStri_ReturnValue_1, bool CallFunc_NotEqual_StriStri_ReturnValue_2, bool CallFunc_NotEqual_StriStri_ReturnValue_3, bool CallFunc_NotEqual_StriStri_ReturnValue_4, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue_2, bool CallFunc_BooleanAND_ReturnValue_3)
{
	...
	Parms.__WorldContext = __WorldContext;
	Parms.LoadoutNames = std::move(LoadoutNames);
	Parms.Temp_int_Array_Index_Variable = Temp_int_Array_Index_Variable;
	Parms.Temp_int_Loop_Counter_Variable = Temp_int_Loop_Counter_Variable;
	Parms.CallFunc_Add_IntInt_ReturnValue = CallFunc_Add_IntInt_ReturnValue;
	Parms.CallFunc_GetLoadoutNames_LoadoutNames = std::move(CallFunc_GetLoadoutNames_LoadoutNames);
	...
	CallFunc_GetLoadoutNames_LoadoutNames = std::move(Parms.CallFunc_GetLoadoutNames_LoadoutNames);

	if (Loadouts != nullptr)
		*Loadouts = Parms.Loadouts;
}
...
// int32                                   CallFunc_Array_Length_ReturnValue                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FCharacterData                   CallFunc_Array_Get_Item                                ()
// bool                                    CallFunc_Less_IntInt_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// struct FDeviceData                      CallFunc_Array_Get_Item_2                              ()
...
// struct FArmourData                      CallFunc_Array_Get_Item_4                              ()
