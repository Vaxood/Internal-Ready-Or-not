...
EMagicLeapIdentityError UMagicLeapIdentity::GetAllAvailableAttributes(TArray<EMagicLeapIdentityKey>* AvailableAttributes)
{
	...
	if (AvailableAttributes != nullptr)
		*AvailableAttributes = Parms.AvailableAttributes;
...
void UMagicLeapIdentity::GetAllAvailableAttributesAsync(TDelegate<void(EMagicLeapIdentityError ResultCode, TArray<EMagicLeapIdentityKey>& AvailableAttributes)>& ResultDelegate)
{
	static class UFunction* Func = nullptr;
...
EMagicLeapIdentityError UMagicLeapIdentity::RequestAttributeValue(TArray<EMagicLeapIdentityKey>& RequestedAttributeList, TArray<struct FMagicLeapIdentityAttribute>* RequestedAttributeValues)
{
	...
	if (RequestedAttributeValues != nullptr)
		*RequestedAttributeValues = Parms.RequestedAttributeValues;
...
EMagicLeapIdentityError UMagicLeapIdentity::RequestAttributeValueAsync(TArray<EMagicLeapIdentityKey>& RequestedAttributeList, TDelegate<void(EMagicLeapIdentityError ResultCode, TArray<struct FMagicLeapIdentityAttribute>& AttributeValue)>& ResultDelegate)
{
	static class UFunction* Func = nullptr;
