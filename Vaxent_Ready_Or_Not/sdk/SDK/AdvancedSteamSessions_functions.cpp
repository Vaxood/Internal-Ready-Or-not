...
struct FBPUniqueNetId UAdvancedSteamFriendsLibrary::CreateSteamIDFromString(class FString& SteamID64)
{
...
bool UAdvancedSteamFriendsLibrary::FilterText(const class FString& TextToFilter, EBPTextFilteringContext Context, struct FBPUniqueNetId& TextSourceID, class FString* FilteredText)
{
	static class UFunction* Func = nullptr;
	...
	if (FilteredText != nullptr)
		*FilteredText = Parms.FilteredText;
...
int32 UAdvancedSteamFriendsLibrary::GetFriendSteamLevel(struct FBPUniqueNetId& UniqueNetId)
{
	static class UFunction* Func = nullptr;
...
class UTexture2D* UAdvancedSteamFriendsLibrary::GetSteamFriendAvatar(struct FBPUniqueNetId& UniqueNetId, EBlueprintAsyncResultSwitch* Result, ESteamAvatarSize AvatarSize)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSteamFriendsLibrary::GetSteamFriendGamePlayed(struct FBPUniqueNetId& UniqueNetId, EBlueprintResultSwitch* Result, int32* AppId)
{
	static class UFunction* Func = nullptr;
...
class FString UAdvancedSteamFriendsLibrary::GetSteamPersonaName(struct FBPUniqueNetId& UniqueNetId)
{
	static class UFunction* Func = nullptr;
...
bool UAdvancedSteamFriendsLibrary::OpenSteamUserOverlay(struct FBPUniqueNetId& UniqueNetId, ESteamUserOverlayType DialogType)
{
	static class UFunction* Func = nullptr;
...
bool UAdvancedSteamFriendsLibrary::RequestSteamFriendInfo(struct FBPUniqueNetId& UniqueNetId, bool bRequireNameOnly)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSteamWorkshopLibrary::GetNumSubscribedWorkshopItems(int32* NumberOfItems)
{
	...
	if (NumberOfItems != nullptr)
		*NumberOfItems = std::move(Parms.NumberOfItems);
}
