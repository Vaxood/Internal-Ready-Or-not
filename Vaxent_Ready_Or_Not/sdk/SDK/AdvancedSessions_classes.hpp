...
public:
	...
	static void GetLoginStatus(struct FBPUniqueNetId& UniqueNetId, EBPLoginStatus* LoginStatus, EBlueprintResultSwitch* Result);
	...
	static void GetPlayerNickname(struct FBPUniqueNetId& UniqueNetId, class FString* PlayerNickname);
	static void GetUserAccount(struct FBPUniqueNetId& UniqueNetId, struct FBPUserOnlineAccount* AccountInfo, EBlueprintResultSwitch* Result);
	static void GetUserAccountAccessToken(struct FBPUserOnlineAccount& AccountInfo, class FString* AccessToken);
	static void GetUserAccountAttribute(struct FBPUserOnlineAccount& AccountInfo, const class FString& AttributeName, class FString* AttributeValue, EBlueprintResultSwitch* Result);
	static void GetUserAccountAuthAttribute(struct FBPUserOnlineAccount& AccountInfo, const class FString& AttributeName, class FString* AuthAttribute, EBlueprintResultSwitch* Result);
	static void GetUserAccountDisplayName(struct FBPUserOnlineAccount& AccountInfo, class FString* DisplayName);
	static void GetUserAccountRealName(struct FBPUserOnlineAccount& AccountInfo, class FString* Username);
	static void GetUserID(struct FBPUserOnlineAccount& AccountInfo, struct FBPUniqueNetId* UniqueNetId);
	static void SetUserAccountAttribute(struct FBPUserOnlineAccount& AccountInfo, const class FString& AttributeName, const class FString& NewAttributeValue, EBlueprintResultSwitch* Result);
...
public:
	...
	static void ShowAccountUpgradeUI(struct FBPUniqueNetId& PlayerRequestingAccountUpgradeUI, EBlueprintResultSwitch* Result);
	...
	static void ShowProfileUI(struct FBPUniqueNetId& PlayerViewingProfile, struct FBPUniqueNetId& PlayerToViewProfileOf, EBlueprintResultSwitch* Result);
...
public:
	...
	static bool IsPlayerMuted(uint8 LocalUserNumChecking, struct FBPUniqueNetId& UniqueNetId);
	static bool IsRemotePlayerTalking(struct FBPUniqueNetId& UniqueNetId);
	static bool MuteRemoteTalker(uint8 LocalUserNum, struct FBPUniqueNetId& UniqueNetId, bool bIsSystemWide);
	static void RegisterAllLocalTalkers();
	static bool RegisterLocalTalker(uint8 LocalPlayerNum);
	static bool RegisterRemoteTalker(struct FBPUniqueNetId& UniqueNetId);
	...
	static bool UnMuteRemoteTalker(uint8 LocalUserNum, struct FBPUniqueNetId& UniqueNetId, bool bIsSystemWide);
	static void UnRegisterAllLocalTalkers();
	static void UnRegisterLocalTalker(uint8 LocalPlayerNum);
	static bool UnRegisterRemoteTalker(struct FBPUniqueNetId& UniqueNetId);
...
public:
	...
	uint8                                         Pad_D64[0x7C];                                     // 0x01AC(0x007C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static void GetFriend(class APlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId, struct FBPFriendInfo* Friend);
	...
	static void IsAFriend(class APlayerController* PlayerController, struct FBPUniqueNetId& UniqueNetId, bool* IsFriend);
	static void SendSessionInviteToFriend(class APlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId, EBlueprintResultSwitch* Result);
...
public:
	...
	static bool BanPlayer(class UObject* WorldContextObject, class APlayerController* PlayerToBan, class FText BanReason);
	static bool EqualEqual_UNetIDUnetID(struct FBPUniqueNetId& A, struct FBPUniqueNetId& B);
	static void FindSessionPropertyByName(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingsName, EBlueprintResultSwitch* Result, struct FSessionPropertyKeyPair* OutProperty);
	static void FindSessionPropertyIndexByName(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, EBlueprintResultSwitch* Result, int32* OutIndex);
	...
	static void GetSessionID_AsString(struct FBlueprintSessionResult& SessionResult, class FString* SessionID);
	static void GetSessionPropertyBool(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, bool* SettingValue);
	static void GetSessionPropertyByte(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, uint8* SettingValue);
	static void GetSessionPropertyFloat(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, float* SettingValue);
	static void GetSessionPropertyInt(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, int32* SettingValue);
	static class FName GetSessionPropertyKey(struct FSessionPropertyKeyPair& SessionProperty);
	static void GetSessionPropertyString(TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class FName SettingName, ESessionSettingSearchResult* SearchResult, class FString* SettingValue);
	...
	static void IsPlayerInSession(class UObject* WorldContextObject, struct FBPUniqueNetId& PlayerToCheck, bool* bIsInSession);
	static bool IsValidSession(struct FBlueprintSessionResult& SessionResult);
	static bool IsValidUniqueNetID(struct FBPUniqueNetId& UniqueNetId);
	static bool KickPlayer(class UObject* WorldContextObject, class APlayerController* PlayerToKick, class FText KickReason);
	...
	static void UniqueNetIdToString(struct FBPUniqueNetId& UniqueNetId, class FString* String);
...
public:
	...
	uint8                                         Pad_D88[0x28];                                     // 0x0050(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D89[0x68];                                     // 0x0050(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x0048 (0x0078 - 0x0030)
class UDestroySessionCallbackProxyAdvanced final  : public UOnlineBlueprintCallProxyBase
{
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D8B[0x28];                                     // 0x0050(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UDestroySessionCallbackProxyAdvanced* DestroySession(class UWorld* WorldContextObject, class APlayerController* PlayerController);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"DestroySessionCallbackProxyAdvanced">();
	}
	static class UDestroySessionCallbackProxyAdvanced* GetDefaultObj()
	{
		return GetDefaultObjImpl<UDestroySessionCallbackProxyAdvanced>();
	}
};
static_assert(alignof(UDestroySessionCallbackProxyAdvanced) == 0x000008, "Wrong alignment on UDestroySessionCallbackProxyAdvanced");
static_assert(sizeof(UDestroySessionCallbackProxyAdvanced) == 0x000078, "Wrong size on UDestroySessionCallbackProxyAdvanced");
static_assert(offsetof(UDestroySessionCallbackProxyAdvanced, OnSuccess) == 0x000030, "Member 'UDestroySessionCallbackProxyAdvanced::OnSuccess' has a wrong offset!");
static_assert(offsetof(UDestroySessionCallbackProxyAdvanced, OnFailure) == 0x000040, "Member 'UDestroySessionCallbackProxyAdvanced::OnFailure' has a wrong offset!");
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D8C[0x28];                                     // 0x0050(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D8D[0x48];                                     // 0x0050(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UFindFriendSessionCallbackProxy* FindFriendSession(class UObject* WorldContextObject, class APlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId);
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D8E[0x80];                                     // 0x0050(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D90[0x20];                                     // 0x0050(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D91[0x40];                                     // 0x0050(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UGetRecentPlayersCallbackProxy* GetAndStoreRecentPlayersList(class UObject* WorldContextObject, struct FBPUniqueNetId& UniqueNetId);
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D92[0x30];                                     // 0x0050(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UGetUserPrivilegeCallbackProxy* GetUserPrivilege(class UObject* WorldContextObject, EBPUserPrivileges& PrivilegeToCheck, struct FBPUniqueNetId& PlayerUniqueNetID);
...
class UJoinSessionCallbackProxyAdvanced final  : public UOnlineBlueprintCallProxyBase
{
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D94[0x130];                                    // 0x0050(0x0130)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UJoinSessionCallbackProxyAdvanced* JoinSession(class UWorld* WorldContextObject, class APlayerController* PlayerController, struct FBlueprintSessionResult& SearchResult);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"JoinSessionCallbackProxyAdvanced">();
	}
	static class UJoinSessionCallbackProxyAdvanced* GetDefaultObj()
	{
		return GetDefaultObjImpl<UJoinSessionCallbackProxyAdvanced>();
	}
};
static_assert(alignof(UJoinSessionCallbackProxyAdvanced) == 0x000008, "Wrong alignment on UJoinSessionCallbackProxyAdvanced");
static_assert(sizeof(UJoinSessionCallbackProxyAdvanced) == 0x000180, "Wrong size on UJoinSessionCallbackProxyAdvanced");
static_assert(offsetof(UJoinSessionCallbackProxyAdvanced, OnSuccess) == 0x000030, "Member 'UJoinSessionCallbackProxyAdvanced::OnSuccess' has a wrong offset!");
static_assert(offsetof(UJoinSessionCallbackProxyAdvanced, OnFailure) == 0x000040, "Member 'UJoinSessionCallbackProxyAdvanced::OnFailure' has a wrong offset!");
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D95[0x48];                                     // 0x0050(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D96[0x28];                                     // 0x0050(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D97[0x40];                                     // 0x0050(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class USendFriendInviteCallbackProxy* SendFriendInvite(class UObject* WorldContextObject, class APlayerController* PlayerController, struct FBPUniqueNetId& UniqueNetIDInvited);
