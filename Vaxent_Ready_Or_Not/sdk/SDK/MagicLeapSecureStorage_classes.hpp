...
public:
	...
	static bool PutSecureArray(const class FString& Key, TArray<int32>& DataToStore);
	...
	static bool PutSecureRotator(const class FString& Key, struct FRotator& DataToStore);
	...
	static bool PutSecureTransform(const class FString& Key, struct FTransform& DataToStore);
	static bool PutSecureVector(const class FString& Key, struct FVector& DataToStore);
