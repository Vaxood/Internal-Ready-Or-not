...
void UW_LoadoutInfo_EffectsList_C::OnModifyWeaponButtonClick__DelegateSignature(class UClass* ItemData)
{
	...
	Params::W_LoadoutInfo_EffectsList_C_OnModifyWeaponButtonClick__DelegateSignature Parms{};
...
void UW_LoadoutInfo_EffectsList_C::OnAttachmentItemClicked__DelegateSignature(class UW_LoadoutInfo_AttachmentListEntry_C* TriggeringListEntry)
{
	...
	Params::W_LoadoutInfo_EffectsList_C_OnAttachmentItemClicked__DelegateSignature Parms{};
...
void UW_LoadoutInfo_EffectsList_C::ExecuteUbergraph_W_LoadoutInfo_EffectsList(int32 EntryPoint, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, float K2Node_Event_Delay_1, bool K2Node_Event_Collapse, bool K2Node_Event_IsGamepad, class FName K2Node_Event_PageName, const struct FSavedLoadout& K2Node_Event_ActiveLoadout, class UW_LoadoutSlot_C* K2Node_Event_CurrentSlot, const TMap<EItemCategory, class UClass*>& K2Node_Event_ItemCategory, class UW_Loadout_C* K2Node_Event_LoadoutWidget, class FName K2Node_Event_OptionNameID, bool K2Node_Event_IsDesignTime, TArray<struct FST_ItemEffects>& K2Node_CustomEvent_Effects, class UUMGSequencePlayer* CallFunc_CreatePlayAnimationProxyObject_Result, class UWidgetAnimationPlayCallbackProxy* CallFunc_CreatePlayAnimationProxyObject_ReturnValue, bool CallFunc_IsValid_ReturnValue, float K2Node_Event_Delay, float CallFunc_Add_FloatFloat_ReturnValue, class UW_LoadoutInfo_EffectsListEntry_C* CallFunc_Array_Get_Item, TScriptInterface<class IReadyOrNotUI_C> CallFunc_Reveal_self_CastInput, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	...
	Parms.K2Node_CustomEvent_Effects = std::move(K2Node_CustomEvent_Effects);
	...
	K2Node_CustomEvent_Effects = std::move(Parms.K2Node_CustomEvent_Effects);
}
...
// Parameters:
// TArray<struct FST_ItemEffects>          Param_Effects                                          (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UW_LoadoutInfo_EffectsList_C::RefreshList(TArray<struct FST_ItemEffects>& Param_Effects)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Effects = std::move(Param_Effects);

	UObject::ProcessEvent(Func, &Parms);

	Param_Effects = std::move(Parms.Param_Effects);
}
