...
bool UMagicLeapPlanesFunctionLibrary::PlanesQueryBeginAsync(struct FMagicLeapPlanesQuery& Query, TDelegate<void(bool bSuccess, TArray<struct FMagicLeapPlaneResult>& Planes, TArray<struct FMagicLeapPlaneBoundaries>& Polygons)>& ResultDelegate)
{
	static class UFunction* Func = nullptr;
...
void UMagicLeapPlanesFunctionLibrary::ReorderPlaneFlags(TArray<EMagicLeapPlaneQueryFlags>& InPriority, TArray<EMagicLeapPlaneQueryFlags>& InFlagsToReorder, TArray<EMagicLeapPlaneQueryFlags>* OutReorderedFlags)
{
	...
	if (OutReorderedFlags != nullptr)
		*OutReorderedFlags = Parms.OutReorderedFlags;
}
