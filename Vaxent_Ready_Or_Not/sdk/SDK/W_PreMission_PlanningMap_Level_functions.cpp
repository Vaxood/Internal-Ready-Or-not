...
void UW_PreMission_PlanningMap_Level_C::OnMarkerDrawn__DelegateSignature(int32 MarkerID, class UW_PreMission_Tablet_MapMarker_C* Marker)
{
	...
	Params::W_PreMission_PlanningMap_Level_C_OnMarkerDrawn__DelegateSignature Parms{};
...
void UW_PreMission_PlanningMap_Level_C::OnLineDrawn__DelegateSignature(int32 LineID, class UCanvasPanel* LineCanvas)
{
	...
	Params::W_PreMission_PlanningMap_Level_C_OnLineDrawn__DelegateSignature Parms{};
...
void UW_PreMission_PlanningMap_Level_C::OnMarkerRotated__DelegateSignature(class UW_PreMission_Tablet_MapMarker_C* TriggeringMarker, int32 FloorLevel, float Rotation)
{
	...
	Params::W_PreMission_PlanningMap_Level_C_OnMarkerRotated__DelegateSignature Parms{};
...
// struct FAnchors                         K2Node_MakeStruct_Anchors                              (NoDestructor)
// class UCanvasPanelSlot*                 CallFunc_AddChildToCanvas_ReturnValue                  (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TDelegate<void(class UW_PreMission_Tablet_MapMarker_C* TriggeringMarker, float Rotation)>K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)

void UW_PreMission_PlanningMap_Level_C::DrawMarker(int32& MarkerID, struct FPlanningMarker& MarkerData, class UW_PreMission_Tablet_MapMarker_C* Marker, class UW_PreMission_Tablet_MapMarker_C* CallFunc_Create_ReturnValue, const struct FAnchors& K2Node_MakeStruct_Anchors, class UCanvasPanelSlot* CallFunc_AddChildToCanvas_ReturnValue, TDelegate<void(class UW_PreMission_Tablet_MapMarker_C* TriggeringMarker, float Rotation)> K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;
...
void UW_PreMission_PlanningMap_Level_C::LineStartNodeSelected(class UW_OfficerMarker_C* OfficerMarker)
{
	...
	Params::W_PreMission_PlanningMap_Level_C_LineStartNodeSelected Parms{};
