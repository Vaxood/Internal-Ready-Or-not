...
// EPlayerHealthStatus                     Temp_byte_Variable_2                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// ETeamType                               Temp_byte_Variable_3                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// ETeamType                               Temp_byte_Variable_4                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class FText                             CallFunc_Conv_IntToText_ReturnValue_8                  ()
// class FText                             K2Node_Select_Default_2                                ()
// class FText                             CallFunc_Conv_IntToText_ReturnValue_9                  ()
...
void UW_ScoreboardEntry_C::SetScoreboardText(class UTextBlock*& InTextWidget, class FText InText, bool Temp_bool_Variable, const struct FSlateColor& K2Node_Select_Default)
{
	...
	InTextWidget = Parms.InTextWidget;
}
...
void UW_ScoreboardEntry_C::UpdateEntry(ETeamType Temp_byte_Variable, const struct FLinearColor& Temp_struct_Variable, const struct FLinearColor& Temp_struct_Variable_1, const struct FLinearColor& Temp_struct_Variable_2, const struct FLinearColor& Temp_struct_Variable_3, const struct FLinearColor& Temp_struct_Variable_4, const struct FLinearColor& Temp_struct_Variable_5, bool Temp_bool_Variable, ETeamType Temp_byte_Variable_1, const struct FLinearColor& Temp_struct_Variable_6, const struct FLinearColor& Temp_struct_Variable_7, const struct FLinearColor& Temp_struct_Variable_8, const struct FLinearColor& Temp_struct_Variable_9, const struct FLinearColor& Temp_struct_Variable_10, const struct FLinearColor& Temp_struct_Variable_11, EPlayerHealthStatus Temp_byte_Variable_2, class FText Temp_text_Variable, class FText Temp_text_Variable_1, class FText Temp_text_Variable_2, class FText Temp_text_Variable_3, class FText Temp_text_Variable_4, class FText Temp_text_Variable_5, class FText Temp_text_Variable_6, bool CallFunc_IsValid_ReturnValue, class APlayerCharacter* K2Node_DynamicCast_AsPlayer_Character, bool K2Node_DynamicCast_bSuccess, float CallFunc_GetNetworkStatus_AvgLag, int32 CallFunc_FTrunc_ReturnValue, EPlayerHealthStatus CallFunc_GetHealthStatus_ReturnValue, class FText CallFunc_Conv_IntToText_ReturnValue, ETeamType CallFunc_GetTeam_ReturnValue, class FText K2Node_Select_Default, const struct FLinearColor& K2Node_Select_Default_1, const struct FLinearColor& K2Node_Select_Default_2, int32 CallFunc_Clamp_ReturnValue, int32 CallFunc_Clamp_ReturnValue_1, class FText CallFunc_Conv_IntToText_ReturnValue_1, class FText CallFunc_Conv_IntToText_ReturnValue_2, int32 CallFunc_Clamp_ReturnValue_2, int32 CallFunc_Clamp_ReturnValue_3, class FText CallFunc_Conv_IntToText_ReturnValue_3, class FText CallFunc_Conv_IntToText_ReturnValue_4, int32 CallFunc_Clamp_ReturnValue_4, float CallFunc_FClamp_ReturnValue, class FText CallFunc_Conv_IntToText_ReturnValue_5, int32 CallFunc_FTrunc_ReturnValue_1, class FText CallFunc_Conv_IntToText_ReturnValue_6, float CallFunc_FClamp_ReturnValue_1, int32 CallFunc_FTrunc_ReturnValue_2, int32 CallFunc_Percent_IntInt_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, class FText CallFunc_Conv_IntToText_ReturnValue_7, const struct FLinearColor& K2Node_Select_Default_3, class FText CallFunc_Conv_IntToText_ReturnValue_8)
{
	...
	Params::W_ScoreboardEntry_C_UpdateEntry Parms{};
