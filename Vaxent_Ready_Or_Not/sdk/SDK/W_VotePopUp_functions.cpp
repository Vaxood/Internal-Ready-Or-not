...
void UW_VotePopUp_C::StartVote(class FText Param_VoteReason, class FText VoteQuestion, bool bCanVoteNo)
{
	static class UFunction* Func = nullptr;
...
ESlateVisibility UW_VotePopUp_C::GetVoteNo_Visibility(bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, bool CallFunc_CanVoteNo_Return_Value, ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
class FText UW_VotePopUp_C::GetYesVotes(class AGameStateBase* CallFunc_GetGameState_ReturnValue, class ACoopGS* K2Node_DynamicCast_AsCoop_GS, bool K2Node_DynamicCast_bSuccess, class FText CallFunc_Conv_IntToText_ReturnValue) const
{
	static class UFunction* Func = nullptr;
...
class FText UW_VotePopUp_C::GetNoVotes(class AGameStateBase* CallFunc_GetGameState_ReturnValue, class ACoopGS* K2Node_DynamicCast_AsCoop_GS, bool K2Node_DynamicCast_bSuccess, class FText CallFunc_Conv_IntToText_ReturnValue) const
{
	static class UFunction* Func = nullptr;
