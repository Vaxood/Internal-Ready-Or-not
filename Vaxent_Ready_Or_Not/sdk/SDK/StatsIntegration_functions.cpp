...
void UGetAchievementData::GetAchievementUnlockStatusAndUnlockTime(const class FString& AchievementAPIName, bool* AchievementUnlocked, struct FDateTime* UnlockTime)
{
	...
	if (AchievementUnlocked != nullptr)
		*AchievementUnlocked = std::move(Parms.AchievementUnlocked);
...
void UGetStoredStats::GetUserStoredStat(const class FString& APIStatName, ESteamStatType StatType, int32* IntegerValue, float* FloatValue)
{
	...
	if (IntegerValue != nullptr)
		*IntegerValue = std::move(Parms.IntegerValue);

	if (FloatValue != nullptr)
		*FloatValue = std::move(Parms.FloatValue);
}
...
// Parameters:
// class FString                           Param_AchievementAPIName                               (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   Param_CurrentProgress                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   Param_MaxProgress                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UIndicateAchievementProgress* UIndicateAchievementProgress::IndicateUserAchievementProgress(const class FString& Param_AchievementAPIName, int32 Param_CurrentProgress, int32 Param_MaxProgress)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_AchievementAPIName = std::move(Param_AchievementAPIName);
	Parms.Param_CurrentProgress = Param_CurrentProgress;
	Parms.Param_MaxProgress = Param_MaxProgress;
