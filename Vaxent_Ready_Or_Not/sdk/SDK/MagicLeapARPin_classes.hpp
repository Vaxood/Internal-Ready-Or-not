...
public:
	...
	uint8                                         Pad_1D6B[0x2];                                     // 0x020E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D6C[0xF0];                                    // 0x02C0(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static class FString ARPinIdToString(struct FGuid& ARPinId);
	static void BindToOnMagicLeapARPinUpdatedDelegate(TDelegate<void(TArray<struct FGuid>& Added, TArray<struct FGuid>& Updated, TArray<struct FGuid>& Deleted)>& Delegate);
	static void BindToOnMagicLeapContentBindingFoundDelegate(TDelegate<void(struct FGuid& PinId, TSet<class FString>& PinnedObjectIds)>& Delegate);
	...
	static EMagicLeapPassableWorldError GetARPinState(struct FGuid& PinId, struct FMagicLeapARPinState* State);
	...
	static EMagicLeapPassableWorldError GetClosestARPin(struct FVector& SearchPoint, struct FGuid* PinId);
	...
	static EMagicLeapPassableWorldError QueryARPins(struct FMagicLeapARPinQuery& Query, TArray<struct FGuid>* Pins);
	static void SetContentBindingSaveGameUserIndex(int32 UserIndex);
	static EMagicLeapPassableWorldError SetGlobalQueryFilter(struct FMagicLeapARPinQuery& InGlobalFilter);
	static void UnBindToOnMagicLeapARPinUpdatedDelegate(TDelegate<void(TArray<struct FGuid>& Added, TArray<struct FGuid>& Updated, TArray<struct FGuid>& Deleted)>& Delegate);
	static void UnBindToOnMagicLeapContentBindingFoundDelegate(TDelegate<void(struct FGuid& PinId, TSet<class FString>& PinnedObjectIds)>& Delegate);
...
public:
	...
	uint8                                         Pad_1D7F[0x7];                                     // 0x0231(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D80[0x7];                                     // 0x0221(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*> AllInfoActors;                                     // 0x0228(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D81[0x8];                                     // 0x0278(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D82[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D83[0xF];                                     // 0x00A1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
