...
static_assert(offsetof(SkinnedDecalSampler_RemoveDecal, Param_Index) == 0x000000, "Member 'SkinnedDecalSampler_RemoveDecal::Param_Index' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_178F[0x7];                                     // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1790[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1791[0x8];                                     // 0x0038(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(SkinnedDecalSampler_SpawnDecal, Param_Index) == 0x000030, "Member 'SkinnedDecalSampler_SpawnDecal::Param_Index' has a wrong offset!");
