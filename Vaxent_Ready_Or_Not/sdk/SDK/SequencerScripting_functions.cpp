...
bool UMovieSceneFolderExtensions::RemoveChildObjectBinding(class UMovieSceneFolder* Folder, struct FSequencerBindingProxy& InObjectBinding)
{
	static class UFunction* Func = nullptr;
...
struct FMovieSceneObjectBindingID UMovieSceneSequenceExtensions::MakeBindingID(class UMovieSceneSequence* MasterSequence, struct FSequencerBindingProxy& InBinding, EMovieSceneObjectBindingSpace Space)
{
	static class UFunction* Func = nullptr;
